...
def _empty_dashboard_metrics() -> dict[str, Any]:
    return {
        ...
        "catalog_metadata": {
            ...
            "indicators": 0,
            "indicator_topics": 0,
            "indicators_without_topic": 0,
            "indicators_without_name": 0,
            "indicators_without_description": 0,
            "is_populated": False,
            "quality_warnings": [],
            "last_indicator_update_label": "Non renseignée",
            "last_etl_label": "Non mesurée",

...
def _build_catalog_metadata(db: Any, etl_events: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    # The current production schema does not contain indicators.updated_at.
    # Keep this value empty instead of querying a non-existing column.
    ...
    return {
        ...
        "last_etl_label": _format_date(last_etl_date) if last_etl_date else "Non mesurée",
